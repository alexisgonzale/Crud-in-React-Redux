...
import { setPropsAsInitial } from '../helpers/serPropsAsInitial';
...
const validate = values => {
    ...
    if (!values.dni) {
        error.dni = " El dni es un ccampo obligatorio"
    }
...
const onlyGrow = (value, previousValue, values) =>
    value && (!previousValue ? value : value) && (value >previousValue ? value : previousValue);
